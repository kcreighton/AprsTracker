                    ...
                    while ((line = file.ReadLine()) != null)
                    {
                        if (line.Contains(textBoxCallsign.Text))
                        {
                            ...
                            if (elements.Length == 8)
                            {
                                ...
                                // TODO: Save timestamps for processed messages, or find some other way to prevent 
                                // processing old messages. Keep lineCount of log file & only process new lines?

                                // TODO: if we are going to process the line, log it
                                // UpdateOutput(line);

                                //TODO: parse source callsign so we know if this is the payload or a chase vehicle.
